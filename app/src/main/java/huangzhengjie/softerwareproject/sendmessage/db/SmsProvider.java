package huangzhengjie.softerwareproject.sendmessage.db;
...
/**
 * Created by asd13_000 on 2015/11/2.
 */
public class SmsProvider extends ContentProvider
{

    private static final String AUTHORITY="huangzhenjie.softwareproject.provider.SmsProvider";
